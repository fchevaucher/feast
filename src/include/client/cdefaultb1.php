...
$query = "SELECT * FROM " . $thisTable . "  WHERE mid = '" . $cMid . "'";
...
src="theme/default/fdbsm.gif" width="67" height="31" border="0" alt="FeastDB" /></td></tr></table><input type="hidden" name="changeType" id="changeType" value="" /><input type="hidden" name="mDay" id="mDay" value="" /><input type="hidden" name="mMonth" value="<?php echo $thisMonth; ?>" /><input type="hidden" name="mYear" value="<?php echo $thisYear; ?>" />
...
<div style="float:right;padding-top:10px"><a href="#" onclick="cancelChange()"><img src="theme/default/editor/cancel.png"
alt="cancel"
title="CANCEL"  onmouseover="this.src = 'editor/cancel_over.png'" onmouseout="this.src = 'editor/cancel.png'"
/></a>&nbsp;<a
href="#" onclick="document.clientedit.submit(); return false;"><img src="theme/default/editor/ok.png" alt="save"
